            ...
            <Container>
                ...
                >
                    ...
                    <div className="flex items-center justify-center gap-3 mt-4">
                        ...
                        <span className="font-bold text-[#1A3C5E]">5.0</span>
                        <span className="text-sm text-[#6B7280]">(38 reviews)</span>
                    </div>
                </motion.div>
                ...
                >
                    <a
                        href="https://www.google.com/maps/place/Apex+Dental+Care/@28.8955,76.5849"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 text-[#2DBD8F] font-semibold hover:underline"
                    >
